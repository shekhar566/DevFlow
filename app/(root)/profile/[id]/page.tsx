...
//             fallbackClassName="text-6xl found-bolder"
//           />
...
const Profile = async ({ params, searchParams }: RouteParams) => {
  ...
  return (
    <>
            ...
            <div className="mt-5 flex flex-wrap items-center justify-start gap-5">
              ...
              {location && (
                <ProfileLink
                  ...
                  title={location} // FIXED: Was 'Portfolio', now shows 'Mayo Clinic', etc.
                />
              )}
              <ProfileLink
                imgUrl="/icons/calendar.svg"
      ...
      <section className="mt-10 flex gap-10">
        <Tabs defaultValue="cases" className="flex-[2]">
          <TabsList className="background-light800_dark400 min-h-[42px] p-1">
            {/* RENAMED TAB: Top Posts -> Patient Cases */}
            <TabsTrigger value="cases" className="tab">
              Patient Cases
            </TabsTrigger>
            {/* RENAMED TAB: Answers -> Clinical Opinions */}
            <TabsTrigger value="opinions" className="tab">
              Clinical Opinions
            </TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="opinions" className="flex w-full flex-col gap-6">
            <DataRenderer
              data={answers}
              empty={EMPTY_ANSWERS}
              success={userAnswersSuccess}
        ...
        <div className="flex w-full min-w-[250px] flex-1 flex-col max-lg:hidden">
          {/* RENAMED SIDEBAR: Top Tech -> Specialties */}
          <h3 className="h3-bold text-dark200_light900">Specialties</h3>
          <div className="mt-7 flex flex-col gap-4">
            <DataRenderer
              data={tags}
              empty={EMPTY_TAGS}
